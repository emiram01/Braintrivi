...
export default function FIGameCompletion({ gameId, correctness, questionAmount, timeCompleted } : Props) {
  return (
    <div className="max-w-2xl mx-auto m-4 md:mt-8 px-4">
      <div className="flex flex-col items-center justify-center w-full p-6 bg-white border-2 border-rose-100 rounded-lg shadow shadow-rose-50">
        <h5 className="mb-2 text-3xl font-bold tracking-tight text-gray-900">Your accuracy was { correctness }% !</h5>
