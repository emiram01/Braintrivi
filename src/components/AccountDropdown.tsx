...
export default function AccountDropdown({ name, email }: Props) {
  return (
    <div className="z-10 bg-white divide-y divide-rose-100 rounded-lg shadow border border-rose-100 w-52 text-sm text-gray-700">
    ...
    <ul className="py-2" aria-labelledby="dropdownInformationButton">
      <li>
        <a href="/" className="block px-4 py-2 hover:bg-rose-50">My Trivia History</a>
      </li>
      <li>
